...
namespace Common.Mod
{
    public static class BuilderUtils
    {
		...
		private static readonly Dictionary<TechType, PrefabInfo> techData = new Dictionary<TechType, PrefabInfo>();
		...
		public static void AddBuildable(PrefabInfo info)
		{
			...
			groups[info.][info.techCategory].Add(info.techType);
