...
namespace AutosortLockers
{
	class ColorPicker : Picker
	{
		...
		public void Initialize(Color initialColor)
		{
			...
			var sprite = ImageUtils.LoadSprite(Mod.GetAssetPath("Circle"), new Vector2(0.5f, 0.5f));
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////
		public static ColorPicker Create(Transform parent, TextMeshProUGUI textPrefabComp)
		{
			...
			Picker.Create(parent, beaconColorPicker, Mod.colors.Count, textPrefabComp);
