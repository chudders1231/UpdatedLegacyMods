...
namespace AutosortLockers
{
	class Picker : MonoBehaviour
	{
		...
		public virtual void Initialize()
		{
			...
			{
				background.sprite = ImageUtils.Load9SliceSprite(Mod.GetAssetPath("PickerBackground"), new RectOffset(100, 100, 100, 100));
			...
			prevPageButton.Initialize("Left", Color.white);
			nextPageButton.Initialize("Right", Color.white);
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////
		protected static void Create(Transform parent, Picker instance, int buttonCount, TextMeshProUGUI textPrefabComp)
		{
